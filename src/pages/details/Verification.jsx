  ...
  return (
    <div className="capitalize font-medium text-xs flex flex-col gap-4 p-10 bg-white shadow-xl rounded-xl">
      ...
      <div className="flex flex-col gap-4">
        <div className="flex justify-between items-center p-4 border border-gray-50  rounded-md">
          <p>Email verified</p>
          <small
        ...
        <div className="flex flex-col p-4 border border-gray-50 rounded-md">
          <div
          ...
          >
            ...
            <small
              className={
                !user?.isKYCVerified ? "text-red-500" : "text-green-500"
              }
            >
